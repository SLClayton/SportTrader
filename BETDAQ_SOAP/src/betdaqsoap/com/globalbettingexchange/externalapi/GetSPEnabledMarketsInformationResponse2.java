    ...
    extends BaseResponse
{
    ...
    protected List<GetSPEnabledMarketsInformationResponse2 .SPEnabledEvent> spEnabledEvent;
     ...
     * 
     */
    public List<GetSPEnabledMarketsInformationResponse2 .SPEnabledEvent> getSPEnabledEvent() {
        if (spEnabledEvent == null) {
            spEnabledEvent = new ArrayList<GetSPEnabledMarketsInformationResponse2 .SPEnabledEvent>();
        }
    ...
    public static class SPEnabledEvent {
        ...
        protected GetSPEnabledMarketsInformationResponse2 .SPEnabledEvent.MarketTypeIds marketTypeIds;
         ...
         *     
         */
        public GetSPEnabledMarketsInformationResponse2 .SPEnabledEvent.MarketTypeIds getMarketTypeIds() {
         ...
         *     
         */
        public void setMarketTypeIds(GetSPEnabledMarketsInformationResponse2 .SPEnabledEvent.MarketTypeIds value) {
