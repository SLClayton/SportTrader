        ...
        try {
            ...
            if(StringUtils.isEmpty(System.getProperty("ASPRISE_OCR_LIB_FILE"))) { 
                fileLib = Utils.extractResourceToFolder(OcrLibHelper.class.getClassLoader(),
                        Utils.firstNotEmpty(System.getProperty("ASPRISE_OCR_LIB_PATH"), libFileName),
                        Utils.getTempFolderWritable(),
                        "true".equalsIgnoreCase(System.getProperty("ASPRISE_OCR_FORCE_WRITE")));
            ...
            */
            ...
            fileLib = new File("resources/aocr_x64.dll");
            System.load(fileLib.getAbsolutePath());
